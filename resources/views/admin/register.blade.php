            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="{{route('admin.register')}}" method="POST" class="register-form" id="register-form">
                            @csrf
                    ...
                    <div class="signup-image">
                        <figure><img src="/authentication/images/signup-image.jpg" alt="sing up image"></figure>
